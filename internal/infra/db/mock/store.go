...
func (m *MockStore) UpdatedAccount(ctx context.Context, arg db.UpdatedAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatedAccount", ctx, arg)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) UpdatedAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatedAccount", reflect.TypeOf((*MockStore)(nil).UpdatedAccount), ctx, arg)
}
